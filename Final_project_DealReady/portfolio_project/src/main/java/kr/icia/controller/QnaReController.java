...
import kr.icia.service.QnaReService;
...
public class QnaReController {
	...
	public ResponseEntity<String> modify(@RequestBody QnaReplyVO vo, @PathVariable("rno") Long rno) {
		vo.setRno(rno);
		log.info("rno: " + rno);
		log.info("modify: " + vo);
